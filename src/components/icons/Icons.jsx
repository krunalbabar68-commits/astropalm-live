/**
 * ============================================
 * AI PALM READER - ICON LIBRARY
 * ============================================
 * 
 * Centralized SVG icons for consistency.
 * You can replace inline SVGs with these imports for cleaner code.
 */
...
export const TarotIcon = ({ className, ...props }) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className} {...props}>
